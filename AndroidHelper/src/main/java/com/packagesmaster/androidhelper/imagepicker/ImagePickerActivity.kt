package com.packagesmaster.androidhelper.imagepicker
...
import com.packagesmaster.androidhelper.imagepicker.provider.CameraProvider
import com.packagesmaster.androidhelper.imagepicker.provider.CompressionProvider
import com.packagesmaster.androidhelper.imagepicker.provider.CropProvider
import com.packagesmaster.androidhelper.imagepicker.provider.GalleryProvider
import com.packagesmaster.androidhelper.imagepicker.util.FileUriUtils
...
class ImagePickerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        internal fun getCancelledIntent(context: Context): Intent {
            val intent = Intent()
            val message = context.getString(R.string.error_occurred)
    ...
    private fun loadBundle(savedInstanceState: Bundle?) {
        ...
        when (provider) {
            ...
            ImageProvider.CAMERA -> {
                ...
                setError(getString(R.string.error_occurred))
            }
        }
    }
